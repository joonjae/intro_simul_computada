program gausiana_1
	...
	implicit none
	logical :: es
	integer :: seed, i, j, n, cont_g ,cont_ac,nbins,parar,max_g,n_ac
	!logical :: parar
...
parar=0
	  do  while (parar==0)
	   !do i = 1, n
		...
		if (cont_g==max_g.or.cont_ac==n_ac) then 
		   parar=1
		end if 
		end do
...
cont_ac=0
  do  while (parar==0)
	   !do i = 1, n
		   ...
		   b=(x-1-0)**2.0
		   b=k*b
		   !b=b/(2.0*x) !normañlizo la integral 
		   b=b
		   if (b<=y) then 
			  cont_ac=cont_ac+1
      		  !print *,i,x,y,cont               
...
print *, "    "   
!print *, "El numero N es:", n
print *, "El numero de Generados sampliando una Uni:", cont_g
print *, "La proporcion Generados/N:", a
print *, "Numero de aceptados:", cont_ac
print *, "La proporcion Aceptados/generasdos:", b
print *, "La integral es:", b
